...
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/app/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/app/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/app/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/app/apps/frontend/template',
)));
